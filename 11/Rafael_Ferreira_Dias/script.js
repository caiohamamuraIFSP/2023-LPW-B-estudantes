...
function loop() {
  ...
  if (y >= floor) y = 230, x = 130, pontosJog2 ++,Jog2.innerHTML = '',Jog2.innerHTML += `Jogador Branco: ${pontosJog2}`;
  velX += xlr8 * acellX;
  velX2 += xlr8 * acellX2;
  verificaColisao();
  limpa();
...
if (y + 70 >= plataforma1 && y + 70 <= plataforma1 + 10 && x >= 300 && x <= 980) {
  if (velY > 0) {
    y = plataforma1 - 70;
    velY = 0;
  }
} else if (y + 70 < plataforma1 && y + 70 >= plataforma2 && x >= 300 && x <= 980) {
  if (velY > 0) {
    y += 10*g;
    if(y >= plataforma1-70)
        y += 0;
...
if (y + 70 >= plataforma2 && y + 70 <= plataforma2 + 10 && x >= 100 && x <= 250) {
  if (velY > 0) {
    y = plataforma2 - 70;
    velY = 0;
  }
} else if (y + 70 < plataforma2 && y + 70 >= plataforma1 && x >= 100 && x <= 250) {
  if (velY > 0) {
    y = plataforma2 - 70;
    velY = 0;
  }
}
  if (y + 70 >= plataforma3 && y + 70 <= plataforma3 + 10 && x >= 1000 && x <= 1130) {
    if (velY > 0) {
      y = plataforma3 - 70;
      velY = 0;
    }
  ...
  //P2
if (y2 + 70 >= plataforma1 && y2 + 70 <= plataforma1 + 10 && x2 >= 300 && x2 <= 980) {
  if (velY2 > 0) {
    y2 = plataforma1 - 70;
    velY2 = 0;
  }
}  else if (y2 + 70 < plataforma1 && y2 + 70 >= plataforma2 && x2 >= 300 && x2 <= 980) {
  if (velY2 > 0) {
    y2 += 10*g;
    if(y2 >= plataforma1-70)
        y2 += 0;
    velY2 = 0;
  }
}

if (y2 + 70 >= plataforma2 && y2 + 70 <= plataforma2 + 10 && x2 >= 100 && x2 <= 250) {
  if (velY2 > 0) {
    y2 = plataforma2 - 70;
    velY2 = 0;
  }
} else if (y2 + 70 < plataforma2 && y2 + 70 >= plataforma1 && x2 >= 100 && x2 <= 250) {
  if (velY2 > 0) {
    y2 = plataforma2 - 70;
    velY2 = 0;
  }
}
if (y2 + 70 >= plataforma3 && y2 + 70 <= plataforma3 + 10 && x2 >= 1000 && x2 <= 1130) {
    if (velY2 > 0) {
      y2 = plataforma3 - 70;
      velY2 = 0;
    }
